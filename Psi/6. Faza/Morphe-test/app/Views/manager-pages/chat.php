      ...
      <div class="inbox_msg">
            ...
            <div class="chat_list active_chat">
             ...
             $klik;
              for ($i = 0; $i < count($klijenti); ++$i){
                  if($poruke[$i]!=null)
                  echo ' <a href='. site_url("Menadzer/chat/".$klijenti[$i]->korisnicko_ime).'><div class="chat_list">
                            <div class="chat_people">
                                <div class="chat_ib">
                                    <h5>'.$klijenti[$i]->korisnicko_ime.'<span class="chat_date">'.$poruke[$i][count($poruke[$i])-1]->datum_vreme_slanja.'</span></h5>
                                    <p>'.$poruke[$i][count($poruke[$i])-1]->tekst.'</p>
                </div>
              </div>
            </div></a>';
                  else  echo ' <a href='. site_url("Menadzer/chat/".$klijenti[$i]->korisnicko_ime).'><div class="chat_list">
                            <div class="chat_people">
                                <div class="chat_ib">
                                    <h5>'.$klijenti[$i]->korisnicko_ime.'<span class="chat_date"></span></h5>
                                    <p></p>
                </div>
              </div>
            </div></a>';
        ...
        <div class="mesgs">
          <div class="msg_history">
             ...
             $idneki=3;
             echo site_url("Menadzer/posalji/".$tmpkli);
             ?>" name="chatform">
            ...
            <div class="input_msg_write" style="vertical-align: middle;">
              ...
              <button style="margin-right: 2%" class="msg_send_btn" id="msg_send_btn" type="submit"><i class="fa fa-paper-plane-o" aria-hidden="true"></i></button>
            </div>
          </div>
             </form>
        </div>
