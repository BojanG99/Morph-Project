      ...
      <form method="POST" action="<?php echo site_url('Menadzer/OceniProgramere')?>">
        <div class="container3" style='height:100%'>
          <p>Čestitamo na završenom projektu korišćenjem naše aplikacije! Značilo bi nam kada biste mogli da nam opišete Vaše iskustvo.
            Takođe, možete oceniti programere sa kojim ste sarađivali na projektu.
          </p>
          <textarea placeholder="Vaše iskustvo na projektu i predlozi za poboljšanje aplikacije.">
          </textarea>
          <br/><br/>
           <?php 
