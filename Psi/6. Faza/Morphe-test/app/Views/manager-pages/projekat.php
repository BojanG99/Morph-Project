  ...
  document.getElementById(id).parentNode.appendChild(document.getElementById(data));
    ...
    <div>
         ...
         <div clas="container">
                <div class="row" ondrop="drop(event)" name="implementacija" ondragover="allowDrop(event)">
                    ...
                    for($i=0;$i<count($rezultat);$i++){
                          $nova= "";
                             $dwnload=site_url('Menadzer/download/' .$rezultat[$i]->idZad );
                 ...
                 <div class="container" style="border:1px solid black">
                    ...
                    <div class="col-12">
                      <ul class="social-links small circle">
                        ...
                        <li ><a href="profile/'.$rezultat[$i]->korisnicko_ime.'/programer"><i class="fa fa-user"></i></a></li>
        ...
        <div style="width:34%;height: 100%;float:left;background-color: #0000ff50">
            ...
            <div clas="container">
                <div class="row" >
                    <div id="div2"align="center" name="testiranje" style="height: 100px;" class="col-12" ondrop="drop(event)" ondragover="allowDrop(event)">TESTIRANJE <i class="fa fa-plug" aria-hidden="true"></i></div>
                    <?php 
                 ...
                 <div class="container" style="border:1px solid black">
                    ...
                    <div class="col-12">
                      <ul class="social-links small circle">
                        ...
                        <li class="googleplus"><a href="profile/'.$rezultat[$i]->korisnicko_ime.'/programer"><i class="fa fa-user"></i></a></li>
        ...
        <div    style="width:33%;height: 100%;float:left;background-color: #00ff0050">
           ...
           <div clas="container">
                <div class="row" >
                    <div id="div3" align="center" name="gotovo" class="col-12" ondrop="drop(event)" ondragover="allowDrop(event)" style="height: 100px;">GOTOVO <i class="fa fa-check" aria-hidden="true"></i></div>
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <a  href="<?php
    echo site_url('Menadzer/dodajZadatak');
    ?>"><button style="margin-left: 45%" class="btn btn-animated btn-success" >Dodaj novi zadatak</button></a>
    <br>
    <br>
    
     <a  href="<?php
    echo site_url('Menadzer/ocenaPrikazi');
    ?>"><button style="margin-left: 46%" class="btn btn-animated btn-success" >Zavrsi projekat</button></a>
</body>
