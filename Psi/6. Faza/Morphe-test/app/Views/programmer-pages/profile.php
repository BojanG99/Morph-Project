    ...
    <div class="container-fluid">
            ...
            <div class="col-7" style="text-align: center">
                <table class="table borderless" style="text-align: center;"> 
                    <tr style="text-align: center">
                        ...
                        <td style="text-align: left; font-size: 20px;"><?php echo $programer->korisnicko_ime; ?></td>
                    </tr>
                    <tr style="text-align: center">
                        <td style="text-align: right; font-size: 20px; font-weight: bold; ">Lozinka: </td>
                        <td style="text-align: left; font-size: 20px;"><?php for ($i = 0 ; $i < strlen($programer->lozinka); $i++) echo "*" ?></td>
                        <?php 
                            if ($myProfile) {
                    ...
                    <tr style="text-align: center">
                        ...
                        <td style="text-align: left; font-size: 20px;"><?php echo $programer->email; ?></td>
                        <?php 
                            if ($myProfile) {
                    ...
                    <tr style="text-align: center">
                        ...
                        <td style="text-align: left; font-size: 20px;"><?php echo $programer->broj_telefona; ?></td>
                        <?php 
                            if ($myProfile) {
                    ...
                    <tr style="text-align: center; ">
                        <td colspan='2' style="text-align: center; font-size: 20px; text-decoration: underline; vertical-align: middle "><a href="<?php echo site_url("Programer/CV/$programer->korisnicko_ime")?>" target="_blank" style="color: black">CV link</a></td>
   
                        <td>
                            <form action="<?php echo site_url('Programer/uploadCV')?>" method="post" enctype="multipart/form-data">
                                    <table class="table borderless" style="text-align: center">
                                        <tr style="text-align: center">
                                            <td style="text-align: center">
                                                <input type="file" name="cvFile" id="cvFile" style="display: none" onchange="form.submit()"> 
                                                <label class="bg-secondary" for="cvFile" style="color:white; border-radius: 5px; padding: 10px">&nbsp&nbspPromeni &nbspCV&nbsp&nbsp</label>
                                            </td>
                                        </tr>
                                    </table>
                            </form>
                ...
                <table class="table borderless" style="text-align: center;">
                    ...
                    <tr style="text-align: center">
                        <td style="text-align: center">
                            ...
                            <form action="<?php echo site_url('Programer/uploadPicture')?>" method="post" enctype="multipart/form-data">
                                <table class="table borderless" style="text-align: center">
                                    <tr style="text-align: center">
                                        <td style="text-align: center">
        ...
        <div class="row">
            <div class="col-7" style="text-align: center">
                <table class="table borderless" style="text-align: center;">
                    <tr style="text-align: center">
                        <td style="text-align: right; font-size: 20px; font-weight: bold; ">Projekti:</td>
                        <td style="text-align: left; font-size: 20px; "><?php echo $brojProjekata?></td>
                        <td style="text-align: right; font-size: 20px; font-weight: bold; ">Broj glasova:</td>
                        <td style="text-align: left; font-size: 20px; "><?php echo $programer->broj_glasova?></td>
                    </tr>
                    
                    <tr style="text-align: center">
                        <td style="text-align: right; font-size: 20px; font-weight: bold; ">Zadaci:</td>
                        <td style="text-align: left; font-size: 20px; "><?php echo $brojZadataka?></td>
                        <td style="text-align: right; font-size: 20px; font-weight: bold; ">Prosecna ocena:</td>
                        <td style="text-align: left; font-size: 20px; "><?php echo $programer->prosecna_ocena?></td>
                    </tr>
                    
                    <tr style="text-align: center">
                        <td style="text-align: right; font-size: 20px; font-weight: bold; ">Vreme:</td>
                        <td style="text-align: left; font-size: 20px; "><?php echo $vreme?></td>
                    </tr>
                </table>
            </div>
        </div>
