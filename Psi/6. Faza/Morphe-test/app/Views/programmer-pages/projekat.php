<!-- Nenad Markovic, Bojan Galic, Vlade Vulic -->
         ...
         <div clas="container">
                ...
                <div class="image-box image-box--shadowed white-bg style-2 mb-4">
                 ...
                 <div class="container" style="border:1px solid black">
                    <div class="row">
                    <div class="col-12">
                    '.$rezultat[$i]->opis.$rezultat[$i]->korisnicko_ime.'
                    </div>
                    <div class="col-12">
                      <ul class="social-links small circle">
                        ...
                        <li ><a href="profile/'.$rezultat[$i]->korisnicko_ime.'"><i class="fa fa-user"></i></a></li>
                 ...
                 <div class="container" style="border:1px solid black">
                    ...
                    <div class="col-12">
                      <ul class="social-links small circle">
                        ...
                        <li class="googleplus"><a href="profile/'.$rezultat[$i]->korisnicko_ime.'"><i class="fa fa-user"></i></a></li>
