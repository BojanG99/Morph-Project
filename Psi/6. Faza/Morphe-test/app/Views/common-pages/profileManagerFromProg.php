...
<body style="background-color: blanchedalmond;">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-7" style="text-align: center">
                <table class="table borderless" style="text-align: center;"> 
                    <tr style="text-align: center">
                        ...
                        <td style="text-align: left; font-size: 20px;"><?php echo $menadzer->korisnicko_ime; ?></td>
                    </tr>
                    <tr style="text-align: center">
                        <td style="text-align: right; font-size: 20px; font-weight: bold; ">Lozinka: </td>
                        <td style="text-align: left; font-size: 20px;"><?php for ($i = 0 ; $i < strlen($menadzer->lozinka); $i++) echo "*" ?></td>
                        <?php 
                            if ($myProfile) {
                    ...
                    <tr style="text-align: center">
                        ...
                        <td style="text-align: left; font-size: 20px;"><?php echo $menadzer->email; ?></td>
                        <?php 
                            if ($myProfile) {
                    ...
                    <tr style="text-align: center">
                        ...
                        <td style="text-align: left; font-size: 20px;"><?php echo $menadzer->broj_telefona; ?></td>
                        <?php 
                            if ($myProfile) {
                ...
                <table class="table borderless" style="text-align: center;">
                    ...
                    <tr style="text-align: center">
                        <td style="text-align: center">
                            ...
                            <form action="<?php echo site_url('Menadzer/uploadPicture')?>" method="post" enctype="multipart/form-data">
                                <?php
         ...
         <div class="row">
            <div class="col-7" style="text-align: center; vertical-align: top;">
                <table class="table borderless" style="text-align: center;">
                    <tr style="text-align: center">
                        ...
                        <td style="text-align: left; font-size: 20px; "><?php echo $menadzer->broj_glasova?></td>
                    </tr>
                    ...
                    <tr style="text-align: center">
                        ...
                        <td style="text-align: left; font-size: 20px; "><?php echo $menadzer->prosecna_ocena?></td>
                    </tr>
