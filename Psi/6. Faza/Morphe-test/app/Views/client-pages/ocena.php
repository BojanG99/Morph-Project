  ...
  <body>
       <div class="container-fluid">
        ...
        <div class="container3">
          <p>Čestitamo na završenom projektu korišćenjem naše aplikacije! Značilo bi nam kada biste mogli da nam opišete Vaše iskustvo.
            Takođe, možete oceniti menadžera sa kojim ste sarađivali na projektu.
          </p>
          <textarea placeholder="Vaše iskustvo na projektu i predlozi za poboljšanje aplikacije." name="textubaci">
          </textarea>
          <br/><br/>
          <div class="forma">
            <label>Ocena za menadžera: &nbsp;</label>
