...
class Programer extends UserUnspecificControler{
    ...
    /**
     * Nenad Markovic
     * Funkcija otvara profil aktivnog korisnika
 ...
 */
    public function project($greske=null) {
          ...
          if($projekat==NULL){ // ovde da se doda gledanje pozivnica
              return $this->index();
          }
   ...
   // mkdir("/tmp/testing", 0777);
    ...
    move_uploaded_file($_FILES['file']['tmp_name'], $zad[0]->ime.'/'.$_FILES['file']['name']);
    header("Location: ". site_url('Programer/project'));
     exit();
    }
...
exit;
    ...
    /**
     * Vlade Vulovic
     * Funkcija vraca konkurse iz baze
     * po odgovorajucim filterima
     * @return prikazuje home stranicu
     * sa odgovarajucim konkursima
     */
    ...
    /**
     * Bojan Galic
     * Azurira zadatak u zavisnosti 
     * u koju kategoriju je ubacen
     * @return Pocetna funkcija klase
     */
...
return;
    ...
    /**
     * Vlade Vulovic
     * Prijavljivanje na konkurs i 
     * azuriranje datog konkursa
     * $idKon - id korisnika koji se 
